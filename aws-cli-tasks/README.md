...
## Step 12: Test Using DNS

### 12.1 Wait for DNS Propagation
```bash
...
### 12.3 Verify in Browser
Open browser and navigate to:
```
http://<ALB_DNS>
```

Example: `http://cli-alb-123456789.us-east-1.elb.amazonaws.com`
...
- [ ] Route tables created with proper routes
- [ ] Security groups created with rules
- [ ] Key pair created and saved
- [ ] EC2 instance launched with user data
- [ ] Nginx installed and running via user data
- [ ] Application Load Balancer created
- [ ] Target group created and registered
- [ ] Listener created
...
```bash
#!/bin/bash
# Run this to delete all created resources
