...
- [ ] NS records updated at registrar (if external)
- [ ] A records point to EC2 public IP
- [ ] DNS propagation complete (check with dig/nslookup)
- [ ] Nginx configured for domain name
- [ ] Website accessible via domain
- [ ] (Optional) SSL/HTTPS working
...
| Domain Registration | ~$1/month (varies by TLD) |
| **Total** | ~$2-3/month |
...
- Implement domain-based path routing with ALB
- Set up email routing with Route 53 and SES
